...
export const durationOptions = ['6 saat', '8 saat', '10 saat'];
const durationField = { id: 'durasi', label: 'Durasi setiap scene (maksimum 10 saat)', options: durationOptions };
...
export const contentTypes: ContentTypeOption[] = [
  ...
  },
  {
    ...
    fields: [
      durationField,
      { id: 'scene', label: 'Jumlah scene', options: ['3 Scene', '4 Scene', '5 Scene', '6 Scene'] },
      { id: 'watak', label: 'Watak animasi', options: ['Produk sebagai watak utama'] },
  ...
  },
  {
    ...
    fields: [
      durationField,
      { id: 'scene', label: 'Jumlah scene', options: ['3 Scene', '4 Scene', '5 Scene', '6 Scene'] },
      { id: 'tangan', label: 'Pilihan tangan', options: ['Tangan Lelaki', 'Tangan Perempuan', 'Tangan memakai sarung'] },
...
export function getInitialValues(contentType: ContentType): Record<string, string> {
  ...
  return Object.fromEntries(config.fields.map((field) => [field.id, field.id === 'durasi' ? '8 saat' : field.options[0]]));
}
